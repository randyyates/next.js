...
function normalizePaths(output: string): string {
  return output
    ...
    .replace(/test\/tmp\/next-test-\d+-\d+\//g, 'TEST_DIR/')
}
...
describe('webpack-loader-parse-error', () => {
  ...
  it('should show parse error for JS loader that returns broken code', async () => {
    ...
    if (isTurbopack) {
      ...
      expect(errorBlock).toMatchInlineSnapshot(`
        "⨯ ./TEST_DIR/app/data.broken.js:3:1
        Parsing ecmascript source code failed
        ...
        Caused by loaders [/TEST_DIR/broken-js-loader.js] transform of file content of TEST_DIR/app/data.broken.js:
        [project]/TEST_DIR/app/data.broken.js:3:46
        ...
        Import trace:
          Server Component:
            ./TEST_DIR/app/data.broken.js
            ./TEST_DIR/app/page.js"
      `)
    }
  })
  ...
  it('should show parse error for CSS loader that returns broken code', async () => {
    ...
    if (isTurbopack) {
      ...
      expect(errorBlock).toMatchInlineSnapshot(`
        "⨯ ./TEST_DIR/app/css-page/styles.broken.css:4:1
        Parsing CSS source code failed
        ...
        Caused by PostCSS transform of loaders [/TEST_DIR/broken-css-loader.js] transform of file content of TEST_DIR/app/css-page/styles.broken.css:
        [project]/TEST_DIR/app/css-page/styles.broken.css:5:15
          3 |   color: red
        ...
        Import trace:
          Client Component Browser:
            ./TEST_DIR/app/css-page/styles.broken.css [Client Component Browser]
            ./TEST_DIR/app/css-page/page.js [Server Component]"
      `)
    }
  })
})
